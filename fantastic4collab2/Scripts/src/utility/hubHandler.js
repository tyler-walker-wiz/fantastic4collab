    ...
    (function (BaseHubHandler) {
        var Hub = /** @class */ (function () {
            function Hub(onStart, onReceive, receiveMessage, otherMessages) {
                ...
                this.forStart = function (chat) {
                    //this.chat = chat;
                    _this.onStart && _this.onStart(chat);
                };
                //if ($.connection && ($.connection as any).appHub)
                try {
                    this.connection = this.chat = $.connection.appHub || $.connection.AppHub;
                    ...
                    var proxy = this.connection.createHubProxy("appHub");
            ...
            Hub.prototype.sendToServer = function (data, connection) {
                if (this.chat && this.chat.server && connection)
                    this.chat.server.send(connection, data);
                else
                    this.chat.send(data);
            };
            Hub.prototype.update = function (groupId, itemId, name, content) {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.chat.invoke("UpdateItem", groupId, itemId, name, content)];
                            case 1:
                                updated = _a.sent();
            ...
            Hub.prototype.lockItem = function (id) {
                return __awaiter(this, void 0, void 0, function () {
                    var canUpdate;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
